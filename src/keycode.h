...
enum _MMKeyCode {
	...
	K_SHIFT = kVK_Shift,
	K_RIGHT_SHIFT = kVK_RightShift,
	K_CAPSLOCK = kVK_CapsLock,
	K_SPACE = kVK_Space,
	K_INSERT = K_NOT_A_KEY,
	K_PRINT_SCREEN = K_NOT_A_KEY,
	K_MENU = K_NOT_A_KEY,
...
enum _MMKeyCode {
	...
	K_SHIFT = XK_Shift_L,
	K_RIGHT_SHIFT = XK_Shift_R,
	K_CAPSLOCK = XK_Shift_Lock,
	K_SPACE = XK_space,
	K_INSERT = XK_Insert,
	K_PRINT_SCREEN = XK_Print,
	K_MENU = K_NOT_A_KEY,
...
enum _MMKeyCode {
	...
	K_SHIFT = VK_SHIFT,
	K_RIGHT_SHIFT = VK_RSHIFT,
	K_ALT = VK_MENU,
	K_RIGHT_ALT = VK_MENU,
	K_CAPSLOCK = VK_CAPITAL,
	K_SPACE = VK_SPACE,
	K_PRINT_SCREEN = VK_SNAPSHOT,
	K_INSERT = VK_INSERT,
	K_MENU = VK_APPS,
